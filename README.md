    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
                        ...
                        <div class="field calendar">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 11" width="210" height="16">
                                <g>
                                    ...
                                    <rect class="day" x="90" y="0" width="11" height="11" fill="#30a14e" rx="2" ry="2"/>
            ...
            <div class="column largeable">
                <h3>On Rumaan repositories</h3>
                <div class="row fill-width">
                    <section class="column">
                        <h3 class="no-margin-top">Issues</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" class="bar" width="220" height="8">
                            <mask id="issues-bar">
                                <rect x="0" y="0" width="220" height="8" fill="white" rx="5"/>
                            </mask>
                            <rect mask="url(#issues-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                            <rect mask="url(#issues-bar)" x="0" y="0" width="94.28571428571428" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="94.28571428571428" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="94.28571428571428" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="94.28571428571428" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="94.28571428571428" y="0" width="125.71428571428571" height="8" fill="#8957e5"/>
                        ...
                        <div class="followup legend field fill-width">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">4 <small>closed</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                    ...
                    <section class="column">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="bar" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="33.41772151898734" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="33.41772151898734" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="33.41772151898734" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="33.41772151898734" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="33.41772151898734" y="0" width="15.780590717299578" height="8" fill="#da3633"/>
                            <rect mask="url(#issues-bar)" x="49.198312236286924" y="0" width="0" height="8" fill="#ff7b72"/>
                            <rect mask="url(#issues-bar)" x="49.198312236286924" y="0" width="170.80168776371306" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#d2a8ff"/>
                        </svg>
                        <div class="followup legend field fill-width">
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">17 <small>closed</small></span>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="row fill-width">
                    <section class="column">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="bar" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                            <rect mask="url(#issues-bar)" x="0" y="0" width="125.71428571428571" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="125.71428571428571" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="125.71428571428571" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="125.71428571428571" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="125.71428571428571" y="0" width="94.28571428571428" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#d2a8ff"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#c9d1d9"/>
                        </svg>
                        <div class="followup legend field fill-width">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">3 <small>closed</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                    <path fill="#8B949E" d="M6.749.097a8.054 8.054 0 012.502 0 .75.75 0 11-.233 1.482 6.554 6.554 0 00-2.036 0A.75.75 0 016.749.097zM4.345 1.693A.75.75 0 014.18 2.74a6.542 6.542 0 00-1.44 1.44.75.75 0 01-1.212-.883 8.042 8.042 0 011.769-1.77.75.75 0 011.048.166zm7.31 0a.75.75 0 011.048-.165 8.04 8.04 0 011.77 1.769.75.75 0 11-1.214.883 6.542 6.542 0 00-1.439-1.44.75.75 0 01-.165-1.047zM.955 6.125a.75.75 0 01.624.857 6.554 6.554 0 000 2.036.75.75 0 01-1.482.233 8.054 8.054 0 010-2.502.75.75 0 01.858-.624zm14.09 0a.75.75 0 01.858.624 8.057 8.057 0 010 2.502.75.75 0 01-1.482-.233 6.55 6.55 0 000-2.036.75.75 0 01.624-.857zm-13.352 5.53a.75.75 0 011.048.165 6.542 6.542 0 001.439 1.44.75.75 0 01-.883 1.212 8.04 8.04 0 01-1.77-1.769.75.75 0 01.166-1.048zm12.614 0a.75.75 0 01.165 1.048 8.038 8.038 0 01-1.769 1.77.75.75 0 11-.883-1.214 6.543 6.543 0 001.44-1.439.75.75 0 011.047-.165zm-8.182 3.39a.75.75 0 01.857-.624 6.55 6.55 0 002.036 0 .75.75 0 01.233 1.482 8.057 8.057 0 01-2.502 0 .75.75 0 01-.624-.858z"/>
                    ...
                    <section class="column">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="bar" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="30.555555555555557" height="8" fill="#da3633"/>
                            <rect mask="url(#issues-bar)" x="30.555555555555557" y="0" width="0" height="8" fill="#ff7b72"/>
                            <rect mask="url(#issues-bar)" x="30.555555555555557" y="0" width="189.44444444444446" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#d2a8ff"/>
                        </svg>
                        <div class="followup legend field fill-width">
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">31 <small>merged</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                    <path fill="#8B949E" d="M2.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0zM3.25 1a2.25 2.25 0 00-.75 4.372v5.256a2.251 2.251 0 101.5 0V5.372A2.25 2.25 0 003.25 1zm0 11a.75.75 0 100 1.5.75.75 0 000-1.5zm9.5 3a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5zm0-3a.75.75 0 100 1.5.75.75 0 000-1.5z"/>
            ...
            <footer>
                ...
                <span>Last updated 18 Jun 2023, 06:07:21 (timezone Asia/Karachi) with lowlighter/metrics@3.33.0</span>
            </footer>
        </div>
